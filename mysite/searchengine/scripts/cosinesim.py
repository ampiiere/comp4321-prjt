...
from searchengine.scripts.tools.ngrams import ngrams_proccess
import re
from searchengine.scripts.tools.porter import porter
...
def cosinesim_main(query):
    ...
    rank_list = [page for page in rank_list if page[1]>0]
    return rank_list # [[docid, score], [docid, score, rank], [docid, score, rank]]
